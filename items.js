...
import { ADDITIONAL_ITEMS, ITEM_NAME_ALIASES } from "./additional-items.js?v=54";
const slug = (value) =>
  String(value)
    .normalize("NFD")
    .replace(/[\u0300-\u036f]/g, "")
...
const ORIGINAL_ITEMS = [
  ...
  utility("Manual operacional", "Acessórios", "I", 1, "Gastando uma ação de interlúdio para ler, permite usar a perícia do manual como se fosse treinado até o próximo interlúdio (um manual aprimorado também concede +5 nela). Só é possível manter o benefício de um manual por vez.", "Sobrevivendo ao Horror", "39"),
  ...
  utility("Dinamite", "Explosivos", "I", 1, "Ação padrão para acender e arremessar em alcance médio; afeta um raio de 6m, causando 4d6 de dano de impacto e 4d6 de dano de fogo, e deixa em chamas (Reflexos DT AGI reduz à metade e evita a condição).", "Sobrevivendo ao Horror", "41"),
  utility("Explosivo plástico", "Explosivos", "I", 1, "Exige 2 rodadas para preparar e colar numa superfície; detona por um controle remoto (ação livre a alcance longo) ou ao sofrer 1+ de dano de fogo ou eletricidade, causando 16d6 de dano de impacto num raio de 3m (Reflexos DT INT reduz à metade). Um especialista em explosivos causa o dobro de dano em objetos/estruturas e ignora a RD delas.", "Sobrevivendo ao Horror", "41"),
  utility("Galão vermelho", "Explosivos", "0", 2, "Ao sofrer dano de fogo ou balístico, explode numa esfera de 6m de raio, causando 12d6 de dano de fogo e deixando em chamas (Reflexos DT 25 reduz à metade e evita a condição); a área afetada continua pegando fogo (1d6 por rodada) até ser apagada ou a cena acabar.", "Sobrevivendo ao Horror", "41"),
  utility("Granada de gás sonífero", "Explosivos", "I", 1, "Libera uma fumaça num raio de 6m por 2 rodadas; quem começa o turno na área fica inconsciente e caído, ou exausto por 1 rodada seguido de fatigado se estiver em atividade física intensa (Fortitude DT AGI reduz para fatigado por 1d4 rodadas).", "Sobrevivendo ao Horror", "41"),
  utility("Granada de PEM", "Explosivos", "I", 1, "Desativa equipamentos elétricos num raio de 18m até o fim da cena; criaturas de Energia na área sofrem 6d6 de dano de impacto e ficam paralisadas por 1 rodada, uma vez por cena (Fortitude DT AGI reduz o dano à metade e evita a condição).", "Sobrevivendo ao Horror", "41"),

  // Sobrevivendo ao Horror — operacionais
  utility("Alarme de movimento", "Operacionais", "0", 1, "Ação completa para posicionar e ativar; sinaliza (de forma discreta ou sonora) sempre que um ser Pequeno ou maior se move num cone de 30m.", "Sobrevivendo ao Horror", "42"),
  ...
  utility("Equipamento de escuta", "Operacionais", "I", 1, "Receptor com alcance de 90m e três transmissores que captam sons num raio de 9m; instalar exige Crime DT 20 (o resultado vira a DT para acharem o transmissor); instalar discretamente na presença de outros exige uma ação completa, Furtividade oposta à Percepção deles e +5 na DT de Crime.", "Sobrevivendo ao Horror", "42"),
  utility("Estrepes", "Operacionais", "0", 1, "Ação padrão para cobrir um quadrado de 1,5m; quem pisa sofre 1d4 de dano de perfuração e fica lento por um dia (Reflexos DT AGI evita); em perseguições, aplicá-los sofre -O no teste da rodada e o perseguidor atingido sofre -O em testes de perseguição até o fim da cena.", "Sobrevivendo ao Horror", "42"),
  utility("Faixa de pregos", "Operacionais", "I", 2, "Funciona como Estrepes, mas cobre uma linha de 9m; veículos de pneu de borracha que passarem por ela têm os pneus furados e o deslocamento reduzido à metade.", "Sobrevivendo ao Horror", "43"),
  utility("Isqueiro", "Operacionais", "0", 0.5, "Produz uma chama pequena e ilumina um raio de 3 m.", "Sobrevivendo ao Horror", "43"),
  utility("Óculos de visão noturna", "Operacionais", "I", 1, "Concede visão no escuro, mas o usuário sofre -O em testes de resistência contra ofuscado e outros efeitos baseados em luz.", "Sobrevivendo ao Horror", "43"),
  ...
  utility("Paraquedas", "Operacionais", "I", 2, "Anula dano de queda. Personagens veteranos em Acrobacia, Pilotagem, Reflexos, Tática ou Profissão específica o usam automaticamente; os demais (ou quedas muito curtas) precisam de um teste de Reflexos DT 20, reduzindo o dano apenas à metade em caso de falha.", "Sobrevivendo ao Horror", "43"),
  ...
  utility("Antitérmico", "Medicamentos", "I", 0.5, "Consumível que permite refazer um teste de resistência contra uma condição mental que o usuário esteja sofrendo, uma vez por cena.", "Sobrevivendo ao Horror", "43"),
  ...
  utility("Ligação direta infernal", "Paranormais", "II", 1, "Ação completa para ligar um veículo automaticamente; ele recebe resistência a dano 20 (cumulativa com RD existente) e imunidade a Sangue, e você recebe +5 em Pilotagem para conduzi-lo. Em troca, as consequências de uma falha em Pilotagem são dobradas (dano ou penalidade). Remover a ligação também exige uma ação completa.", "Sobrevivendo ao Horror", "44"),
  utility("Medidor de condição vertebral", "Paranormais", "II", 1, "Conectá-lo exige uma ação completa e deixa o usuário atordoado por 1 rodada. A vestimenta concede +2 em Fortitude, indica a condição de saúde do usuário por cores e dá +5 em testes de Medicina para auxiliá-lo.", "Sobrevivendo ao Horror", "44"),
  utility("Pé de morto", "Paranormais", "II", 1, "Botas paranormais que concedem +5 em Furtividade; em cenas de furtividade, ações chamativas que envolvam apenas se mover (como correr ou saltar) aumentam a visibilidade em apenas +1 (em vez do normal).", "Sobrevivendo ao Horror", "45"),
  utility("Pendrive selado", "Paranormais", "II", 0.5, "Não pode ser invadido nem afetado por rituais, seres e efeitos de Energia, protegendo seus arquivos e permitindo invadir outros dispositivos sem ser contaminado.", "Sobrevivendo ao Horror", "45"),
  utility("Valete da salvação", "Paranormais", "I", 0.5, "Ação padrão para atirá-la ao ar; ela voa em alcance médio apontando para a melhor rota de fuga e deixa de existir. Se usada numa cena de perseguição, garante sucesso automático em uma ação de cortar caminho.", "Sobrevivendo ao Horror", "45"),
